...
<?php
echo '<div class="university-result">';
echo '<center><p><strong>GAFL IB University Results</strong></p></center>';
echo '<center><img class="result" src="university-result.png"></center>';
echo '';
echo '</div>';
?>
